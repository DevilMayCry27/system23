...
const PatientLaboratoryModal = (props) => {
  const {
    form,
    islaboratoryModalVisible,
    showModal,
    userId,
  ...
  const getData = async () => {
    await OnGetLaboratoryList(userId);
  };
  ...
  return (
    <Modal
      ...
      visible={islaboratoryModalVisible}
      onOk={showModal}
      onCancel={showModal}
      maskClosable={false}
      closable={true}
...
export default connect(mapStateToProps, mapDispatchToProps)(PatientLaboratoryModal);
